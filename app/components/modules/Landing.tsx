...
export const Landing = () => {
    return (
        <div className="min-h-screen w-full grid place-content-center bg-gradient-radial from-federal_blue-300 via-black_raisin-200 to-black_raisin">
            <div className="flex flex-col text-center content-center space-y-6">
                ...
                <div className="flex flex-row space-x-8 place-content-center">
                    ...
                    <Button filled={false}>Resume</Button>
                </div>
            </div>
        </div>
    )
